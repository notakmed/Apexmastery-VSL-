  ...
  function renderResult(tier) {
    ...
    const calendlySection = `
      <div class="calendly-section">
        ...
        <!-- Booking Embed -->
        <iframe src="https://link.apexmasterymembers.com/widget/booking/WHCA39KySFSxmTvQKN6f" style="width: 100%; height: 700px; border:none;" scrolling="yes" id="WHCA39KySFSxmTvQKN6f_1776979147857"></iframe><br><script src="https://link.apexmasterymembers.com/js/form_embed.js" type="text/javascript"></script>
